...
void EG2104_init()
{
    ...
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_1, 0.0f *  __HAL_TIM_GET_AUTORELOAD(&htim1));
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, 0.0f *  __HAL_TIM_GET_AUTORELOAD(&htim1));
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_3, 0.0f *  __HAL_TIM_GET_AUTORELOAD(&htim1));
    __HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_4, 0.0f *  __HAL_TIM_GET_AUTORELOAD(&htim1));
